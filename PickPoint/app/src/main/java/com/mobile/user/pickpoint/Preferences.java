...
public class Preferences {
    ...
    public static final String RSA_GENERATED = "com.mobile.user.RSA_GENERATED";
    public static final String RSA_PUBLIC_KEY = "com.mobile.user.RSA_PUBLIC_KEY";
    public static final String RSA_PRIVATE_KEY = "com.mobile.user.RSA_PRIVATE_KEY";
    public static final String ENCRYPTED_MESSAGE = "com.mobile.user.ENCRYPTED_MESSAGE";
